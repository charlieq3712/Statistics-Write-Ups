...
(a)All animals to fly, i.e. ?????1; 
(b)No animals to fly, i.e. ?????0. 
This is a uniform prior on ??. 
...
(1) ??=(0,1);
(2) E[??]=0.43, i.e. about 2/5 of animals fly;
(3) V[??]=0.03, i.e. we're pretty certain ??'s around 0.43. 
